          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Comprehensive master (coach) information and analytics
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">
                    {new Set(masters.filter(m => m.branch).map(m => m.branch!.id)).size}
                  </p>
                </div>
                      ...
                      <tr key={master.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-4 px-4">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => router.push(`/dashboard/coaches/${master.id}`)}
